...
export default function QRCodeGenerator({ userId }: QRCodeGeneratorProps) {
  ...
  return (
    <div className="flex flex-col items-center justify-center p-6 bg-card text-card-foreground rounded-2xl shadow-lg border border-gray-100 dark:border-gray-800 max-w-sm mx-auto animate-fade-in">
      ...
      <button 
        ...
        className="w-full py-3 px-4 bg-primary text-primary-foreground font-semibold rounded-xl hover:opacity-90 transition-colors shadow-sm"
      >
        Print Badge
      </button>
